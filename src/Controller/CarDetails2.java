 ...
 */
public class Phadda_1 implements Initializable {
...
connection c;
    ...
    @FXML
    private Label snameL1;
    @FXML
    private Label SellerName1;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try{
          ...
          try{
            ...
            SellerName1.setText(c.rs.getString("name"));
            PhoneNo1.setText(c.rs.getString("pno"));
            Address1.setText(c.rs.getString("addr"));
        }catch(Exception e){
            e.printStackTrace();
        }
